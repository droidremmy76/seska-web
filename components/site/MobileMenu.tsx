...
export default function MobileMenu() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        "[data-menu-link]",
        { y: 32, opacity: 0 },
        { y: 0, opacity: 1, stagger: 0.055, duration: 0.5, ease: "power3.out", delay: 0.18 }
      );
    }, panelRef);
  ...
  return (
    <>
      ...
      {open ? (
        <div id="mobile-navigation" ref={panelRef} className="mobile-menu" role="dialog" aria-modal="true" aria-label="Site navigation">
          <div className="mobile-menu-top">
            <span>SESKA / KAMPALA</span>
          ...
          <div className="mobile-menu-actions" data-menu-link>
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">WhatsApp {SESKA_DATA.info.whatsappFormatted} ↗</a>
          </div>
