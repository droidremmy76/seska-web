...
export default function ContactPage() {
  ...
  return (
    ...
    >
      ...
      <section className="inner-section split-section"><div className="trust-image" style={{ minHeight: 500 }}><Image src="/media/workshop-real.jpg" alt="Seska Investments workshop in Kampala" fill sizes="(max-width: 900px) 100vw, 50vw" style={{ objectFit: "cover", objectPosition: "center 48%" }} /></div><div className="contact-visual" style={{ minHeight: 500 }}><Image src="/media/merchandise.svg" alt="Seska branded corporate merchandise" fill sizes="(max-width: 900px) 100vw, 50vw" /></div></section>
