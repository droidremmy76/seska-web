...
export const metadata: Metadata = {
  ...
  description: "Explore Seska Investments services in Kampala: digital and offset printing, large-format signage, apparel branding, PVC IDs, graphic design, plotting, awards and print finishing.",
