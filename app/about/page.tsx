...
export default function AboutPage() {
  return (
    <InnerShell
      ...
      heroAlt="Seska Investments large-format production workshop in Kampala"
    ...
    >
      ...
      <section className="inner-section split-section"><div className="trust-image" style={{ minHeight: 520 }}><Image src="/media/workshop-real.jpg" alt="Seska Investments production workshop on Nasser Road, Kampala" fill sizes="(max-width: 900px) 100vw, 50vw" style={{ objectFit: "cover", objectPosition: "center 48%" }} /></div><div className="inner-prose"><span className="inner-label">REAL PRODUCTION / NASSER ROAD</span><h2>DESIGN, PRINT, FINISH AND DISPATCH UNDER ONE WORKFLOW.</h2><p>Our production environment brings commercial printing, large-format output, identification, branded apparel and finishing closer together so specifications can move from artwork to finished product with practical oversight.</p></div></section>
