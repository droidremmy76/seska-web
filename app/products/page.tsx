...
export default function ProductsPage() {
  return (
    <InnerShell index="03 / PRODUCTS" eyebrow="STATIONERY & BRANDING" title="USEFUL OBJECTS. VISIBLE BRANDS." intro="A curated range of corporate merchandise, apparel, identification products, awards and stationery that keeps your brand present beyond the printed page." accent="yellow">
